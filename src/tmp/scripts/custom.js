  ...
  function init_template() {
    ...
    $('.menu-box').each(function () {
      ...
      if (menuType === "menu-box-modal") {
        $(this).css({"width": menuWidth, "height": menuHeight});
      }
      if (menuType === "menu-box-left") {
        $(this).css({"width": menuWidth, "height": "auto", "transform": "translateX(-100%)"});
      }
      if (menuType === "menu-box-right") {
        $(this).css({"width": menuWidth, "height": "auto", "transform": "translateX(100%)"});
      }
      if (menuType === "menu-box-bottom") {
        $(this).css({"height": menuHeight, "width": "auto", "transform": "translateY(100%)"});
      }
    ...
    menuDeployer.on('click', function () {
      ...
      if (menuEffect === "menu-push") {
        if (menuType === "menu-box-top") {
          menuPushElements.css({'transform': 'translateY(' + menuHeight + 'px)'});
        }
        if (menuType === "menu-box-bottom") {
          menuPushElements.css({'transform': 'translateY(' + menuHeight * (-1) + 'px)'});
        }
        if (menuType === "menu-box-left") {
      ...
      if (menuEffect === "menu-parallax") {
        if (menuType === "menu-box-top") {
          menuPushElements.css({'transform': 'translateY(' + menuHeightParallax + 'px)'});
        }
        if (menuType === "menu-box-bottom") {
          menuPushElements.css({'transform': 'translateY(' + menuHeightParallax * (-1) + 'px)'});
        }
        if (menuType === "menu-box-left") {
          menuPushElements.css({'transform': 'translateX(' + menuWidthParallax + 'px)'});
        }
        if (menuType === "menu-box-right") {
          menuPushElements.css({'transform': 'translateX(' + menuWidthParallax * (-1) + 'px)'});
        }
        menuID.addClass('menu-active');
      }
    ...
    $('[data-toggle-theme], .toggle-theme').on('click', function () {
      ...
      if ($('body').hasClass('theme-light')) {
        eraseCookie('Asterial_dark_mode');
        createCookie('Asterial_light_mode', true, 1);
      }
      if ($('body').hasClass('theme-dark')) {
        eraseCookie('Asterial_light_mode');
        createCookie('Asterial_dark_mode', true, 1);
      }
      return false;
    });
    if (readCookie('Asterial_dark_mode')) {
      $('body').removeClass('theme-light').addClass('theme-dark');
    }
    if (readCookie('Asterial_light_mode')) {
      $('body').removeClass('theme-dark').addClass('theme-light');
    }
    //Detect Dark Theme
    if ($('body').hasClass('theme-light')) {
      $('body').find('.toggle-switch[data-toggle-theme], .toggle-theme').addClass('toggle-off').removeClass('toggle-on');
    }
    if ($('body').hasClass('theme-dark')) {
      $('body').find('.toggle-switch[data-toggle-theme], .toggle-theme').addClass('toggle-on').removeClass('toggle-off');
    }
